const quotes = [
    ...
    {
        quote: "전쟁의 가장 끔찍한 특징 가운데 하나는 모든 전쟁 선전물, 모든 악다구나와 거짓말, 증오가 언제나 싸우지 않는 사람들에게서 나온다는 점이다.",
    ...
    {
        quote: "사랑이란 부서지기 쉬운거야. (...) 하지만 어쩌만 부서진 파편은 다시 보관할 수 있지.",
    ...
    {
        quote: "그럼에도 나는 다음 여행을 준비한다. 행복은 바라는 대로 주어지는게 아니라 노력과 의지로 맺는 열매 같은 것이라는 걸 나는 여행을 통해 알게 되었기 때문이다.",
        author: "이 지랄맞음이 쌓여 축제가 되겠지 - 조승리",
    },
    {
        quote: '어떻게 고양이를 네 마리나 키우게 되었느냐고 누가 묻는다면 이렇게 답할 수 있을 것 같다. "인생에는 사람이 계획한다고 해도 그렇게 되지 않는 일이 참 많잖아요. 고양이 문제라면 특히 그렇습니다."',
        author: "여자 둘이 살고 있습니다. - 김하나, 황선우",
    },
    {
